using MAUI_Swiper.Utils;

namespace MAUI_Swiper.Controls;
...
public partial class SwiperControl : ContentView
{
	...
	private const double DecisionThreashold = 0.4d;
	...
	private void CalculatePanState(double panX)
	{
		...
		var passedDeadzone = panX < 0 ? deadZoneEnd : panX - deadZoneEnd;
		var decisionZoneEnd = DecisionThreashold * halfScreenWidth;
